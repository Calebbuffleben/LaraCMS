...
<head>
	<meta charset="UTF-8">
	<title>Dashboard - Blog com níveis de usuário</title>
...
<body>
		...
		<ul class="menu col-md-12">
			<li class="col-md-2 text-center">
				<a href="<?php echo e(url('/dashboard')); ?>">
					<img src="<?php echo e(url('assets/painel/imgs/acl-branca.png')); ?>" alt="LaraMuic" class="logo">
				</a>
			</li>
	...
	<div class="footer actions">
		<div class="container text-center">
			<p class="footer">Caleb Buffleben - Consultor Digital</p>
		</div>
	</div>
